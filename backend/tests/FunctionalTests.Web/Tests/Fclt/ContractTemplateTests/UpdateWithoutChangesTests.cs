...
public sealed class UpdateWithoutChangesTests : BaseUpdateWithoutChangesTests<ContractTemplate, ContractTemplateInput>
{
  ...
  protected override async Task<ContractTemplate> ArrangeAsync(IServiceProvider scopedServices)
  {
    var repository = scopedServices.GetRequiredService<IRepository<ContractTemplate>>();
    ...
    var contractTemplateToUpdate = contractTemplateFaker.Generate();
    await repository.AddAsync(contractTemplateToUpdate);

    return contractTemplateToUpdate;
  }

  protected override ContractTemplateInput MapEntityToInput(ContractTemplate entity)
    => MappingHelper.Fclt.MapContractTemplateInput(entity);

  protected override Task AssertAsync(
    IServiceProvider scopedServices,
    ContractTemplate entityToUpdate,
    ContractTemplate updatedEntity)
  {
