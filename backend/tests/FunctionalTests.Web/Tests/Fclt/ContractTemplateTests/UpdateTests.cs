...
public sealed class UpdateTests : BaseUpdateWithIdParameterTests<ContractTemplate, ContractTemplateInput>
{
  ...
  protected override async Task<(ContractTemplate EntityToUpdate, ContractTemplateInput Input)> ArrangeAsync(
    IServiceProvider scopedServices)
  {
    ...
    return (contractTemplateToUpdate, input);
  }
  ...
  {
    AssertHelper.Fclt.ContractTemplateEqual(input, updatedEntity);
