...
public sealed class UpdateTests : BaseUpdateWithIdParameterTests<SLA, SLAInput>
{
  ...
  protected override async Task<(SLA EntityToUpdate, SLAInput Input)> ArrangeAsync(
    IServiceProvider scopedServices)
  {
    ...
    return (slaToUpdate, input);
  }

  protected override async Task AssertAsync(IServiceProvider scopedServices, SLAInput input, SLA updatedEntity)
  {
    ...
    AssertHelper.Fclt.SLAEqual(input, updatedEntity);
  }
}
