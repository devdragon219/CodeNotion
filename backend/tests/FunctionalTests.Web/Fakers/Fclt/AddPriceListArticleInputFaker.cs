...
public sealed class AddPriceListArticleInputFaker : BaseSeededFaker<AddPriceListArticleInput>
{
  ...
  public AddPriceListArticleInputFaker() : base(seed: 1)
  {
    CustomInstantiator(faker =>
    {
      var input = new AddPriceListArticleInput()
      {
      ...
      input.Since = faker.Date.BetweenDateOnly(new DateOnly(2022, 01, 01), new DateOnly(2024, 01, 01));
      input.Price = faker.Random.Decimal(5, 100).Round2();
