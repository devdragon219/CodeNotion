        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseClass = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    MeasurementUnit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    MeasurementUnitDescription = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TimeOfUseRateCount = table.Column<int>(type: "integer", nullable: false),
                    MeteringType = table.Column<int>(type: "integer", nullable: false),
                    HasHeatingAccountingSystem = table.Column<bool>(type: "boolean", nullable: false),
                    ChargeFields = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilityUserCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    UtilityContractCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    UtilityMeterSerial = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    UtilityDeliveryPointCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    IsFreeMarket = table.Column<bool>(type: "boolean", nullable: false),
                    Deposit = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
                    ...
                    ContractPowerMaximum = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ContractPowerNominal = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ContractNominalTension = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalVATAmount = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
                    InvoicedConsumptionAmount = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UtilityServiceId = table.Column<int>(type: "integer", nullable: false),
                    Notes = table.Column<string>(type: "character varying(3192)", maxLength: 3192, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CostChargeConsumptionCostChargeId = table.Column<int>(type: "integer", nullable: false),
                    TOURateIndex = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CostCharge_ActualConsumption_Values_CostCharges_CostChargeC~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CostCharge_ExpectedConsumption_Values_CostCharges_CostCharg~",
                        column: x => x.CostChargeConsumptionCostChargeId,
                        principalSchema: "nrgy",
                        principalTable: "CostCharges",
                        principalColumn: "Id",
