...
namespace RealGimm.Infra.PgSql.IAM
{
    ...
    [Migration("20241030134910_MakeWidgetsStoredAsEntities")]
    partial class MakeWidgetsStoredAsEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RealGimm.Core.IAM.UserAggregate.WidgetSection", b =>
                {
                    ...
                    b.Property<int?>("facilityDashboardUser")
                        .HasColumnType("integer");

                    b.Property<int?>("mainDashboardUser")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("facilityDashboardUser");

                    b.HasIndex("mainDashboardUser");
            ...
            modelBuilder.Entity("RealGimm.Core.IAM.UserAggregate.WidgetSection", b =>
                {
                    b.HasOne("RealGimm.Core.IAM.UserAggregate.User", null)
                        ...
                        .HasForeignKey("facilityDashboardUser")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RealGimm.Core.IAM.UserAggregate.User", null)
                        .WithMany("MainDashboard")
                        .HasForeignKey("mainDashboardUser")
                        .OnDelete(DeleteBehavior.Cascade);
                });
