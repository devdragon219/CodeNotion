...
[AnagConfig]
public class ManagementSubjectConfiguration : IEntityTypeConfiguration<ManagementSubject>
{
  public void Configure(EntityTypeBuilder<ManagementSubject> builder)
  {
