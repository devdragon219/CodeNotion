        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CadastralValueFactor = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    CadastralValueTaxFactor = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Ordering = table.Column<int>(type: "int", nullable: false),
                    IsForEstate = table.Column<bool>(type: "bit", nullable: false),
                    IsForEstateUnit = table.Column<bool>(type: "bit", nullable: false),
                    IsForEstateSubUnit = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainUsageTypeId = table.Column<int>(type: "int", nullable: false),
                    UsageTypeId = table.Column<int>(type: "int", nullable: false),
                    SurfaceAreaSqM = table.Column<int>(type: "int", nullable: true),
                    ...
                    ManagementOrgUnitId = table.Column<int>(type: "int", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(3192)", maxLength: 3192, nullable: true),
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TotalMarketValue_TotalSurfaceAreaSqM = table.Column<int>(type: "int", nullable: true),
                    TotalMarketValue_Notes = table.Column<string>(type: "nvarchar(3192)", maxLength: 3192, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LocationLatLon = table.Column<Point>(type: "geography", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateTotalMarketValueEstateId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EstateTotalMarketValueCoefficient_Estates_EstateTotalMarketValueEstateId",
                        column: x => x.EstateTotalMarketValueEstateId,
                        principalSchema: "asst",
                        principalTable: "Estates",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Position = table.Column<float>(type: "real", nullable: false),
                    TemplateReference = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EstateId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingPermitYear = table.Column<int>(type: "int", nullable: true),
                    Condition = table.Column<int>(type: "int", nullable: false),
                    AgeCoefficient = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateId = table.Column<int>(type: "int", nullable: false),
                    ReferenceYear = table.Column<int>(type: "int", nullable: false),
                    IASValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    RBAValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    MortgageAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    TransferYear = table.Column<int>(type: "int", nullable: true),
                    RevampOperations = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CatalogueTypeId = table.Column<int>(type: "int", nullable: false),
                    UsageTypesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedArea = table.Column<bool>(type: "bit", nullable: false),
                    ProcurementActId = table.Column<int>(type: "int", nullable: true),
                    ManagementSubjectId = table.Column<int>(type: "int", nullable: false),
                    CostCentreId = table.Column<int>(type: "int", nullable: true),
                    DisusedDate = table.Column<DateOnly>(type: "date", nullable: true),
                    DeletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastRelevantChangeDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EstateId = table.Column<int>(type: "int", nullable: false),
                    AddressId = table.Column<int>(type: "int", nullable: false),
                    SubNumbering = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    StairId = table.Column<int>(type: "int", nullable: true),
                    OfficialActId = table.Column<int>(type: "int", nullable: true),
                    HistoryTags = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRelevantChangeDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HistoryTags = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsCadastralRegistrationInProgress = table.Column<bool>(type: "bit", nullable: false),
                    IsAncillaryUnit = table.Column<bool>(type: "bit", nullable: false),
                    Income_CadastralCategoryId = table.Column<int>(type: "int", nullable: true),
                    Income_CadastralLandCategoryId = table.Column<int>(type: "int", nullable: true),
                    Income_MacroCategory = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Income_MicroCategory = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Income_Metric = table.Column<int>(type: "int", nullable: true),
                    Income_MetricAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_MetricRentedAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_RegisteredSurface = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_Type = table.Column<int>(type: "int", nullable: true),
                    Income_CadastralAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_FarmAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_LandAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    Income_MarketValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    CadastralNotes = table.Column<string>(type: "nvarchar(3192)", maxLength: 3192, nullable: true),
                    FiscalNotes = table.Column<string>(type: "nvarchar(3192)", maxLength: 3192, nullable: true),
                    ConsortiumNotes = table.Column<string>(type: "nvarchar(3192)", maxLength: 3192, nullable: true),
                    ...
                    Inspection_ProtocolNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Inspection_Heading = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Inspection_MacroZone = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Inspection_MicroZone = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Inspection_IsHistoricalEstate = table.Column<bool>(type: "bit", nullable: true),
                    Inspection_IsDirectRestriction = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CadastralUnits_CadastralCategories_Income_CadastralCategoryId",
                        column: x => x.Income_CadastralCategoryId,
                        principalSchema: "asst",
                        principalTable: "CadastralCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CadastralUnits_CadastralLandCategories_Income_CadastralLandCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OccupancyPercent = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurfaceSqMTotal = table.Column<int>(type: "int", nullable: true),
                    SurfaceSqMCommonArea = table.Column<int>(type: "int", nullable: true),
                    SurfaceSqMSideArea = table.Column<int>(type: "int", nullable: true),
                    FloorId = table.Column<int>(type: "int", nullable: true),
                    FunctionAreaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventReason = table.Column<int>(type: "int", nullable: true),
                    UnitStatus = table.Column<int>(type: "int", nullable: true),
                    IsAssignable = table.Column<bool>(type: "bit", nullable: true),
                    IsKeysReturned = table.Column<bool>(type: "bit", nullable: true),
                    IsWithValuables = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevaluationFactor = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CadastralUnitId = table.Column<int>(type: "int", nullable: false),
                    TaxCalculator = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    TaxCalculatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    ExpectedInstallments = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ITTavPartita = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ITTavCorpo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ITTavPorzione = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UnmanagedOverride = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CadastralUnitId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AssetTaxCalculationId = table.Column<int>(type: "int", nullable: true),
                    ManagementSubjectId = table.Column<int>(type: "int", nullable: false),
                    ManagementSubjectBankAccountId = table.Column<int>(type: "int", nullable: true),
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    PropertyMonths = table.Column<int>(type: "int", nullable: false),
                    GrossCadastralIncome = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    ActualizedCadastralIncome = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    BaseTaxableAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    DebitedAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    CreditedAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    TaxName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    IsDefinitive = table.Column<bool>(type: "bit", nullable: false),
                    ExpectedDueDate = table.Column<DateOnly>(type: "date", nullable: false),
                    InstallmentsPaid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Issue = table.Column<int>(type: "int", nullable: true),
                    IsIssueOverridden = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[CadastralUnitId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstateTotalMarketValueCoefficient_EstateTotalMarketValueEstateId",
                schema: "asst",
