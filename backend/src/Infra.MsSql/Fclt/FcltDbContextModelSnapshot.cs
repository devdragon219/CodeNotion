...
namespace RealGimm.Infra.MsSql.Fclt
{
    ...
    partial class FcltDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.ContractAggregate.Contract", b =>
                {
                    ...
                    b.Property<string>("CatalogueTypeIds")
                        .IsRequired()
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.ServiceAggregate.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Services", "fclt");
                });

            modelBuilder.Entity("RealGimm.Core.Fclt.ServiceCategoryAggregate.ServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServiceCategories", "fclt");
                });

            modelBuilder.Entity("RealGimm.Core.Fclt.ServiceCategoryAggregate.ServiceSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServiceSubCategory", "fclt");
                });
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.TicketAggregate.Ticket", b =>
                {
                    ...
                    b.Property<string>("CatalogueItemIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.TicketChecklistAggregate.TicketChecklist", b =>
                {
                    ...
                    b.Property<string>("OnTriggerActivityIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PreventativeActivityIds")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PreventativeCraftId")
                        .HasColumnType("int");

                    b.Property<string>("PreventativeDaysOfWeek")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.TicketChecklistTemplateAggregate.TicketChecklistTemplate", b =>
                {
                    ...
                    b.Property<IEnumerable<int>>("PreventativeDaysOfWeek")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.SLAAggregate.ComplexTicketCondition", b =>
                {
                    ...
                    b.HasIndex("SLAIfId")
                        .IsUnique()
                        .HasFilter("[SLAIfId] IS NOT NULL");

                    b.HasIndex("SLAThenId")
                        .IsUnique()
                        .HasFilter("[SLAThenId] IS NOT NULL");
            ...
            modelBuilder.Entity("RealGimm.Core.Fclt.ServiceAggregate.Service", b =>
                {
                    b.HasOne("RealGimm.Core.Fclt.ServiceCategoryAggregate.ServiceCategory", "Category")
                        .WithMany("Services")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RealGimm.Core.Fclt.ServiceCategoryAggregate.ServiceSubCategory", "SubCategory")
                        .WithMany("Services")
                        .HasForeignKey("SubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("RealGimm.Core.Fclt.ServiceAggregate.ServiceActivity", "Activities", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("ServiceActivity", "fclt");
