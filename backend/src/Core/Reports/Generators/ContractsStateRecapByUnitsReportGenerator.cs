...
public class ContractsStateRecapByUnitsReportGenerator : ReportGenerator
{
  ...
  private readonly IStringLocalizer<ContractsStateRecapByUnitsReportGenerator> _localizer;
  ...
  public static Guid StaticId => Guid.Parse("4b593b88-65eb-447b-ae82-32d07ea6db7a");
  ...
  public ContractsStateRecapByUnitsReportGenerator(
    ...
    IStringLocalizer<ContractsStateRecapByUnitsReportGenerator> localizer,
  ...
  protected override async Task<PdfDocument> GeneratePdfReportAsync(Dictionary<string, ReportGeneratorFilter> filters)
  {
    ...
    foreach (var row in data)
    {
      ...
      {
        tableRow.Cells[4].AddParagraph("-");
        tableRow.Cells[5].AddParagraph("-");
        tableRow.Cells[6].AddParagraph("-");
        tableRow.Cells[7].AddParagraph("-");
      }
  ...
  protected override async Task<XLWorkbook> GenerateExcelReportAsync(Dictionary<string, ReportGeneratorFilter> filters)
  {
    ...
    var worksheet = workbook.AddWorksheet(_localizer["ReportTitle"].Value[..31]);
  ...
  private async Task<List<EstateUnitData>> GetInnerDataAsync(Dictionary<string, ReportGeneratorFilter> filters)
  {
    ...
    var estateUnitIds = estateUnits.Select(estateUnit => estateUnit.Id);
    ...
    var contracts = await _contractRepository
      ...
      .Where(contract => contract.LocatedUnits.Any(locatedUnit => estateUnitIds.Contains(locatedUnit.EstateUnitId)))
      .ToListAsync();
