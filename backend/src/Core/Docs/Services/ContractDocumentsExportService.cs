...
public class ContractDocumentsExportService : ExportService<ContractDocumentsFlatOutput, ContractDocumentsExportService>
{
  protected override Dictionary<string, Func<ContractDocumentsFlatOutput, XLCellValue>> CreateExcelDataSelector()
    => new Dictionary<string, Func<ContractDocumentsFlatOutput, XLCellValue>>()
    {
      [nameof(ContractDocumentsFlatOutput.ContractInternalCode)] = data
