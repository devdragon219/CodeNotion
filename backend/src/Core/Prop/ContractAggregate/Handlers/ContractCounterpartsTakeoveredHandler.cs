...
public class ContractCounterpartsTakeoveredHandler : TenantMessageHandler<ContractCounterpartsTakeoveredEvent>
{
  ...
  protected override async Task HandlePerTenant(ContractCounterpartsTakeoveredEvent message)
  {
