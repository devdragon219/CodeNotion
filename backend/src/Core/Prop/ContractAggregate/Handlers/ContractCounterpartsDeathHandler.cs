...
public class ContractCounterpartDeathHandler : TenantMessageHandler<ContractCounterpartDeathEvent>
{
  ...
  public required ILogger<ContractCounterpartDeathHandler> Logger { protected get; init; }

  protected override async Task HandlePerTenant(ContractCounterpartDeathEvent message)
  {
    ...
    var registryCommunication = await RegistryCommunicationService.CreateRegistryCommunicationAsync(
      contract,
      CommunicationType.Ita_RLI12_Death);
