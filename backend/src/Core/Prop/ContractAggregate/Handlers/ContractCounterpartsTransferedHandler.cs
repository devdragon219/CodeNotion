...
public class ContractCounterpartsTransferedHandler : TenantMessageHandler<ContractCounterpartsTransferedEvent>
{
  ...
  public required ILogger<ContractCounterpartsTransferedHandler> Logger { protected get; init; }

  protected override async Task HandlePerTenant(ContractCounterpartsTransferedEvent message)
  {
    ...
    var registryCommunication = await RegistryCommunicationService.CreateRegistryCommunicationAsync(
      contract,
      CommunicationType.Ita_RLI12_Transfer);
