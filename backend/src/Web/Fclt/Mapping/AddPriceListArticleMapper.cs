...
public class AddPriceListArticleMapper : IMapper<AddPriceListArticleInput, PriceListArticle>
{
  ...
  public AddPriceListArticleMapper(
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    pricePeriod.SetSince(from.Since);
    pricePeriod.SetPrice(from.Price);
