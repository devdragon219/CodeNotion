...
export type SlaFragment = { __typename?: 'SLA'; internalCode: string; description: string; id: number };

export type SlaDetailFragment = {
  __typename?: 'SLA';
  internalCode: string;
  description: string;
  id: number;
...
export const SlaFragmentDoc = gql`
...
`;
export const SlaDetailFragmentDoc = gql`
