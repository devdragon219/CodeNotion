...
export type AssetTaxPaymentFragment = {
...
export const AssetTaxPaymentFragmentDoc = gql`
  fragment AssetTaxPaymentFragment on AssetTaxDetailRow {
    cityName
    address {
      ...AsstAddressFragment
    }
    ...
    estateUnitsCount
    subRows {
      ...AssetTaxDetailEstateItemFragment
    }
  }
`;
