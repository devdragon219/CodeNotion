...
export type TicketsPerEstateUnitFragment = {
...
export const TicketsPerEstateUnitFragmentDoc = gql`
  fragment TicketsPerEstateUnitFragment on TicketsPerEstateUnit {
    locationEstateUnit {
      id
      internalCode
    }
    tickets {
      ...FacilityContractTicketFragment
    }
  }
`;
