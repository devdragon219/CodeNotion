...
export type FacilityContractTemplateFragment = {
...
export type FacilityContractTemplateDetailFragment = {
  __typename?: 'ContractTemplate';
  id: number;
  description: string;
  internalCode: string;
...
export const FacilityContractTemplateFragmentDoc = gql`
...
`;
export const FacilityContractTemplateDetailFragmentDoc = gql`
