import { ContentCategory, EstateUnitDocumentsFlatOutputFilterInput } from '@realgimm5/frontend-common/gql/types';
...
export const getEstateUnitDocumentsFilterInput = (
  { id: columnId }: TableColumn<DocumentsTableRow>,
  value: unknown,
): EstateUnitDocumentsFlatOutputFilterInput => {
  switch (columnId) {
