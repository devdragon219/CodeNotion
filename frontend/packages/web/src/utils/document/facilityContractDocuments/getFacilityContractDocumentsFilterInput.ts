import { ContentCategory, FcltContractDocumentsFlatOutputFilterInput } from '@realgimm5/frontend-common/gql/types';
...
export const getFacilityContractDocumentsFilterInput = (
  { id: columnId }: TableColumn<DocumentsTableRow>,
  value: unknown,
): FcltContractDocumentsFlatOutputFilterInput => {
  switch (columnId) {
