import { CatalogueDocumentsFlatOutputFilterInput, ContentCategory } from '@realgimm5/frontend-common/gql/types';
...
export const getCatalogueDocumentsFilterInput = (
  { id: columnId }: TableColumn<DocumentsTableRow>,
  value: unknown,
): CatalogueDocumentsFlatOutputFilterInput => {
  switch (columnId) {
