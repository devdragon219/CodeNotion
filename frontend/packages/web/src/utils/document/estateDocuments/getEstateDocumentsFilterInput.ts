import { ContentCategory, EstateDocumentsFlatOutputFilterInput } from '@realgimm5/frontend-common/gql/types';
...
export const getEstateDocumentsFilterInput = (
  { id: columnId }: TableColumn<DocumentsTableRow>,
  value: unknown,
): EstateDocumentsFlatOutputFilterInput => {
  switch (columnId) {
