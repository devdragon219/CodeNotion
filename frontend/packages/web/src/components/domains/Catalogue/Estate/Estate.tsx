...
import { CatalogueEstateProps } from './Estate.types';

export const CatalogueEstate = ({ control, mode, readonly }: CatalogueEstateProps) => {
  const {
    i18n: { language },
    t,
  } = useTranslation();
  ...
  return (
    <Grid2 container spacing={{ xs: 2, sm: 3 }}>
      {mode === FormMode.Create && <SectionTitle value="catalogue.section_title.estate" />}
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              {...field}
              label={t('catalogue.field.estate_code')}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <TextField {...field} label={t('catalogue.field.external_estate_code')} readonly={readonly} disabled />
          )}
        />
      </Grid2>
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <TextField {...field} label={t('catalogue.field.estate_name')} readonly={readonly} disabled />
          )}
        />
      </Grid2>
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              ...
              label={t('catalogue.field.estate_address')}
              readonly={readonly}
              disabled
            />
          )}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <SelectField
              {...field}
              label={t('catalogue.field.estate_status')}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <SelectField
              {...field}
              label={t('catalogue.field.estate_type')}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <SelectField
              {...field}
              label={t('catalogue.field.estate_ownership')}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <TextField {...field} label={t('catalogue.field.estate_management_subject')} readonly={readonly} disabled />
          )}
        />
      </Grid2>
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              {...field}
              label={t('catalogue.field.estate_management_org_unit')}
              readonly={readonly}
              disabled
            />
          )}
      ...
      <Grid2 size={12}>
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <TextField {...field} label={t('catalogue.field.notes')} readonly={readonly} multiline disabled />
          )}
        />
      </Grid2>
    </Grid2>
