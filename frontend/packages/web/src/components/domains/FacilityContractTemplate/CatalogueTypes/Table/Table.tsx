...
import { FacilityContractTemplateCatalogueTypesTableProps } from './Table.types';

export const FacilityContractTemplateCatalogueTypesTable = ({
  catalogueTypes,
  useRowExpandCollapse = true,
}: FacilityContractTemplateCatalogueTypesTableProps) => {
