...
import { FacilityContractSlasTransferListProps } from './TransferList.types';

export const FacilityContractSlasTransferList = ({
  control,
  errors,
  mode,
  where,
  onAddSlas,
  onOpenCalendar,
}: FacilityContractSlasTransferListProps) => {
        ...
        <Controller
          ...
          render={({ field }) => (
            <TransferList
              ...
              empty="facility_contract.text.no_slas_selected"
              rows={slas}
              titles={{
                left: 'facility_contract.section_title.select_slas',
                right: 'facility_contract.section_title.selected_slas',
              }}
