      ...
      <Grid2 size={12}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              {...field}
              label={t('catalogue_category.field.catalogue_sub_category_parent')}
              error={!!errors.name}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              {...field}
              label={t('catalogue_category.field.catalogue_sub_category_code')}
      ...
      <Grid2 size={{ xs: 12, sm: 6 }}>
        <Controller
          ...
          render={({ field }) => (
            <TextField
              {...field}
              label={t('catalogue_category.field.catalogue_sub_category_name')}
