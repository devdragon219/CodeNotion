...
import { CatalogueEstatesProps } from './Estates.types';

export const CatalogueEstates = ({ setValue }: CatalogueEstatesProps) => {
  const {
    i18n: { language },
    t,
  } = useTranslation();
  ...
  return (
    <Grid2 container spacing={{ xs: 2, sm: 3 }}>
      ...
      <SectionTitle value="catalogue.section_title.estate" />
      <Grid2 size={12}>
        <PrimaryTable
          color="secondary"
